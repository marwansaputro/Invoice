                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: const [
                          Text('Good morning 👋', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800)),
                          SizedBox(height: 4),
                    ...
                    Container(
                      ...
                      child: const Text('PE', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 13)),
                    ),
                  ],
                ),
              ),
                ...
                child: ListView(
                  ...
                  children: [
                    AnimatedEntry(
                      ...
                      offsetY: 16,
                      child: _StatChip(label: 'Paid', value: stats.paid, color: AppColors.success, icon: Icons.check_circle_rounded),
                    ),
                    const SizedBox(width: 12),
                    AnimatedEntry(
                      delay: const Duration(milliseconds: 180),
                      offsetY: 16,
                      child: _StatChip(label: 'Pending', value: stats.pending, color: AppColors.warning, icon: Icons.schedule_rounded),
                    ),
                    const SizedBox(width: 12),
                    AnimatedEntry(
                      delay: const Duration(milliseconds: 260),
                      offsetY: 16,
                      child: _StatChip(label: 'Overdue', value: stats.overdue, color: AppColors.danger, icon: Icons.error_rounded),
                    ),
                  ],
                ),
              ),
          ...
          SliverPadding(
            ...
            sliver: SliverToBoxAdapter(
              child: Row(
                ...
                children: [
                  const Text('Recent Invoices', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w800)),
                  TextButton(
                    onPressed: () => Navigator.of(context).push(SlideFadeRoute(page: const InvoicesScreen())),
            ...
            SliverToBoxAdapter(
              child: SizedBox(
                ...
                child: EmptyState(
                  ...
                  message: 'Create your first invoice and start tracking your payments.',
                ),
              ),
            )
          else
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: AppColors.primary.withOpacity(0.28), blurRadius: 26, offset: const Offset(0, 14)),
        ],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              const Text('Total Revenue', style: TextStyle(color: Colors.white70, fontSize: 13, fontWeight: FontWeight.w600)),
              const Spacer(),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: AppColors.success.withOpacity(0.25), borderRadius: BorderRadius.circular(20)),
                  child: const Text('+18.4%', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 11.5)),
                ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          AnimatedNumber(value: value, style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 15)),
        ],
      ),
    );
  }
